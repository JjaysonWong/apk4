...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('apk4_keycode', function (Blueprint $table) {
            ...
            $table->string('area', 100)->default('')->comment('源代理显示');
            $table->string('url')->default('')->comment('页面隐藏');
    ...
    {
        Schema::dropIfExists('apk4_keycode');
    }
};
