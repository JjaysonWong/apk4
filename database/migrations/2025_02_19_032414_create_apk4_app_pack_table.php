...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('apk4_app_pack', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('gameid')->unique('gameid')->comment('游戏id');
            ...
            $table->string('pc_url', 500)->nullable()->default('https://s.syzs.qq.com/channel/6/5898/anzhuang_1000208037.exe')->comment('pc下载地址');
    ...
    {
        Schema::dropIfExists('apk4_app_pack');
    }
};
